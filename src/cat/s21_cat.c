...
void check_options(int argc, char **argv) {
    ...
    int number_of_element_of_argv = 1, numbering = 1, counter_n = 1, count_of_flags = 0;
    ...
    FILE *file_to_open;
    if((file_to_open = fopen(argv[number_of_element_of_argv], "r")) == NULL) { 
        printf("Нет такого файла или каталога\n");
        number_of_element_of_argv++; 
    } else {
